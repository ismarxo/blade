<section class="container mx-auto 2xl:mx-auto xl:mx-auto lg:mx-auto md:mx-auto sm:mx-auto  xxx">
    <{!! $section['data']['title__status'] !!} class="text-5xl leading-tight mb-5 font-black text-gray-800 dark:text-gray-100 mx-4">
        ...
        @if ($section['data']['wysiwyg'])
            <div class="wysiwyg xxx">
                {!! App::getWYSIWYG($section['data']['wysiwyg']) !!}
            </div>
        @endif
        <div class="my-4 mx-4 grid grid-cols-1 gap-y-10 sm:grid-cols-2 md:grid-cols-3 gap-x-6 lg:grid-cols-4 xl:grid-cols-4 xl:gap-x-8 xxx">
