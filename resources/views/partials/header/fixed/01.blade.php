<div class="bg-white fixed w-full top-0 left-0">
    <div class="absolute inset-0 shadow z-30 pointer-events-none" aria-hidden="true"></div>
    <div class="relative z-20">

        <div
            class="max-w-7xl mx-auto flex justify-between items-center py-5 px-4 sm:py-4 md:justify-start md:space-x-10">
            ...
            <div class="hidden md:flex-1 md:flex md:items-center md:justify-between ">
                <nav class="flex space-x-10">
                    <div>
                        ...
                        <button type="button" data-js="menuButton"
                        ...
                        <!--
                            ...
                            -->
                        <div class="hidden absolute z-10 top-full inset-x-0 transform shadow-lg bg-white"
                            data-js="menuSubmenu">
                            <div
                    ...
                    <div>
                        ...
                        <!--
                                ...
                                To: "opacity-0 -translate-y-1"
                            -->
                        <div data-js="menuSubmenu"
                            class="hidden absolute z-10 top-full inset-x-0 transform shadow-lg">
                                            ...
                                            <li class="flow-root">
                                                <a href="#" class="-m-3 p-3 flex rounded-lg hover:bg-gray-100">
                                                    ...
                                                    <div class="w-0 flex-1 sm:ml-8">
                                                        ...
                                                        <p class="mt-1 text-sm text-gray-500">
                                                            Eget ullamcorper ac ut vulputate fames
                                                            nec mattis pellentesque elementum.
