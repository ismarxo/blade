<div class="py-2 bg-gradient-to-r from-indigo-600 to-light-blue-500 overflow-hidden">
    <div class="relative max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <svg fill="none" viewBox="0 0 848 513"
        ...
        </svg><svg fill="none" viewBox="0 0 848 513"
        ...
        <div class="relative flex justify-center items-center">
            <div class="text-sm font-medium text-white">Just-in-Time: The Next Generation of Tailwind&nbsp;CSS</div><span
                aria-hidden="true" class="hidden sm:block mx-6 h-6 w-px bg-white bg-opacity-20"></span>
            <div class="ml-6 sm:ml-0"><a
                    class="whitespace-nowrap inline-flex rounded-md bg-white py-2 px-3 text-xs font-semibold uppercase text-blue-500 hover:bg-opacity-90"
                    href="/docs/just-in-time-mode">Learn more →</a></div>
        </div>
    </div>
</div>
